        ...
        child: ListView(
          ...
          children: [
            const UserAccountsDrawerHeader(
              accountName: Text('Lutfita Az-zahra'),
              accountEmail: Text('2024160005'),
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            _statItem(
                'Personal',
                _repo.countByCategory(Category.personal).toString(),
                Icons.person),
            _statItem(
                'Pekerjaan',
                _repo.countByCategory(Category.pekerjaan).toString(),
                Icons.work),
            _statItem(
                'Lainnya',
                _repo.countByCategory(Category.lainnya).toString(),
                Icons.label),
          ],
        ),
      ),
