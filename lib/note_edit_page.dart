...
class _NoteEditPageState extends State<NoteEditPage> {
  ...
  void initState() {
    super.initState();
    _note = NoteRepository.instance.findById(widget.noteId);
  ...
  void _save() {
    if (!_formKey.currentState!.validate() || _note == null) return;
    final updated = _note!.copyWith(
      title: _titleCtrl.text.trim(),
      content: _contentCtrl.text.trim(),
      category: _selectedCategory,
    );
    NoteRepository.instance.update(updated);
    context.pop(updated);
  }
            ...
            children: [
              ...
              DropdownButtonFormField<Category>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: Category.pekerjaan, child: Text('Pekerjaan')),
                  DropdownMenuItem(value: Category.lainnya, child: Text('Lainnya')),
                ],
                onChanged: (val) {
